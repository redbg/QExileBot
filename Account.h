...
protected:
    void run() override
    {
        ...
        connect(m_ExileGame, &ExileGame::errorOccurred, this, [=](QAbstractSocket::SocketError socketError)
                { m_BackendError = m_ExileClient->m_BackendError; this->quit(); });
        ...
        // 选择角色成功,进入游戏
        connect(m_ExileClient, &ExileClient::SelectCharacterSuccess, m_ExileGame, &ExileGame::connectToGameServer);
